package com._onesafe.zk;

import com._onesafe.thread.booleanlock.Lock;
...
/**
 * Created by onesafe on 09/01/2019.
 */
public class LockTest {

    private String zkQurom = "172.27.132.65:2181";
...
//                }
//            });
            zk = new ZooKeeper(zkQurom, 6000, null);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            zk.exists(nodeString, new Watcher() {
                ...
                public void process(WatchedEvent watchedEvent) {
                    ...
                    System.out.println("Get watchedEvent....." + watchedEvent.getType());
